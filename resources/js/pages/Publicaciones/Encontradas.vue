<template>
    <div class="perdidas-wrapper">

        <!-- HERO -->
        <div class="hero">
            <h1>Mascotas <span class="highlight">encontradas</span></h1>
            <p>Estas mascotas fueron encontradas y esperan volver con su familia. Si reconocés a alguna, contactate.</p>

            <div class="hero-actions">
                <Link href="/publicaciones/crear?tipo=encontrado" class="btn-publicar">
